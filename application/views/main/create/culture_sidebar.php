...
/**
 * Culture Create Sidebar
 *
 * Addition to the Culture Form which loads the sidebar used in Creation
 *
 * @category    LIIS-View
 * @author      Matt Forster / @frostyforster
 * @author      Graham Fluet
...
<div class="span3" id="sidebar">
    <div class="well text-center">
        <a class="btn btn-main btn-large" id="submitCulture" data-position="left" data-intro="Click this button to record your data!"
        data-step="2">Create Culture 	</a>
        </br>
        </br>
