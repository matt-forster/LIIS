 ...
 * Sample Sidebar
 *
 * Addition to the Main Sample Form which adds the sidebar used in creation
 *
 * @category    LIIS-View
 * @author      Matt Forster / @frostyforster
 * @author      Graham Fluet
...
<div class="span3" id="sidebar">
    <div class="well text-center">
        <a class="btn btn-main btn-large" id="submitSample" data-position="left" data-intro="Click this button to record your data!"
        data-step="2">Create Sample 		</a>
        </br>
        </br>
