                ...
                <div class="accordion-inner">
                    ...
                    Vial Id: '.$vial[ 'VIAL_ID']. '
                        ...
                        <div class="pull-right" style="margin-top: -29px; margin-right: 5px;">
                            <a href="'.site_url('culture/delete/vial/'.$vial['VIAL_ID']).'" class="btn btn-danger btn-mini">Delete</a>
                        </div>
                        '; } echo '
                </div>
    ...
    <div id="collapseFive" class="accordion-body collapse">
        <div class="accordion-inner">
            ...
            Id: '.$tube[ 'DNARNA_ID']. '
                ...
                === 'ADMIN'){ echo '
                <div class="pull-right" style="margin-top: -29px; margin-right: 5px;">
                    <a href="'.site_url('culture/delete/dnarna/'.$tube['DNARNA_ID']).'" class="btn btn-danger btn-mini">Delete</a>
                </div>
                '; } echo '
        </div>
        <div id="collapse'.$counter.'" class="accordion-body collapse" style="height: 0px;">
