...
<div class="fixed" id="selected">
    ...
    <div class="span4">
        ...
        data-step="5">
            ...
            <p class="muted">
                <a href="<?php echo site_url('sample/create/'); ?>" class="btn btn-main btn-large widebtn">Create</a> a new record from scratch.
            </p>
            ...
            <p class="muted">
                <?php
                    if($this->session->userdata('user_auth') === 'LIMITED'){ 
                       ...
                       echo '<a href="'.site_url('/sample/import/').'" class="btn btn-large widebtn">Import</a>
                                records from a csv.';
                    }
                ?>
            ...
            <?php
                if($this->session->userdata('user_auth') === 'LIMITED'){ 
                   ...
                   echo ' <a href="'.site_url('sample/export/').'" class="btn btn-large widebtn">Export</a>
                            a project to a csv.';
                }
            ?>
